...
<section>
  ...
  <input type="text" placeholder="Lugar expedicion Documento" name="expedicion" required/>
  ...
  <input type="number" placeholder="Documento del acudiente" name="acudiente" required/>
</section>
